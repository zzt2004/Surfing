...
- 订阅地址添加成功后重启手机，可能有些网络等原因故不会自动下载完全规则，请手动至 Web App 在代理页的最下方，手动点击至规则页右下方刷新图标更新/下载规则文件，如网络原因无法使用 App 请至浏览器复制并打开
  - `127.0.0.1:9090/ui`  
...
> 不推荐使用如非特殊需要，使用该模式前请勿使用(黑白名单)，值得注意的是，使用该模式会使网络流畅度缓慢
</details>
